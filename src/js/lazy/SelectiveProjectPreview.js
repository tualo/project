Ext.define('Tualo.project.lazy.SelectiveProjectPreview', {
    extend: 'Ext.panel.Panel',
    requires: [
        'Tualo.project.lazy.models.SelectiveProjectPreview',
        'Tualo.project.lazy.controller.SelectiveProjectPreview'
    ],
    alias: 'widget.selective_project_preview',
    controller: 'selective_project_preview',

    viewModel: {
        type: 'selective_project_preview'
    },
    listeners: {
        boxReady: 'onBoxReady'
    },
