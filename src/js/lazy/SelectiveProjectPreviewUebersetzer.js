Ext.define('Tualo.project.lazy.SelectiveProjectPreviewUebersetzer', {
    extend: 'Ext.panel.Panel',
    requires: [
        'Tualo.project.lazy.models.SelectiveProjectPreviewUebersetzer',
        'Tualo.project.lazy.controller.SelectiveProjectPreviewUebersetzer'
    ],
    alias: 'widget.selective_project_preview_uebersetzer',
    controller: 'selective_project_preview_uebersetzer',

    viewModel: {
        type: 'selective_project_preview_uebersetzer'
    },
    listeners: {
        boxReady: 'onBoxReady'
    },
