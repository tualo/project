CREATE OR REPLACE FUNCTION `convertAllSubProjectOffer`(use_project_id varchar(36)) RETURNS longtext 
    DETERMINISTIC
BEGIN
...
-- END IF;
    ...
    for sub in (select project_id from projectmanagement_subproject where parent_project = use_project_id) do
        ...
        where 
            ...
            and projectmanagement_tasks.amount<>0
            -- and projectmanagement.offer_id = 0;
